...
<p align="center">
  <img alt="Version 1.0.4" src="https://img.shields.io/badge/version-1.0.4-7C3AED">
...
| --- | --- |
| Android phone or tablet | `Killua-IPTV-Android-1.0.4.apk` |
| **Fire TV Stick / Android TV** | `Killua-IPTV-Android-1.0.4.apk` — the same file |
| Windows, installed | `Killua-IPTV-Windows-1.0.4.msi` |
| Windows, no installer | `Killua-IPTV-Windows-1.0.4.zip` |
...
4. The television asks whether to trust the computer — tick **Always allow**, accept, then:
   ...
   ```bash
   adb install Killua-IPTV-Android-1.0.4.apk
   ```
...
**The installer** — `Killua-IPTV-Windows-1.0.4.msi`
...
**Or without installing** — `Killua-IPTV-Windows-1.0.4.zip`
