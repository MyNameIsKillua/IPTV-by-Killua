...
<p align="center">
  <img alt="Version 1.0.5" src="https://img.shields.io/badge/version-1.0.5-7C3AED">
...
| --- | --- |
| Android phone or tablet | `Killua-IPTV-Android-1.0.5.apk` |
| **Fire TV Stick / Android TV** | `Killua-IPTV-Android-1.0.5.apk` — the same file |
| Windows, installed | `Killua-IPTV-Windows-1.0.5.msi` |
| Windows, no installer | `Killua-IPTV-Windows-1.0.5.zip` |
...
4. The television asks whether to trust the computer — tick **Always allow**, accept, then:
   ...
   ```bash
   adb install Killua-IPTV-Android-1.0.5.apk
   ```
...
**The installer** — `Killua-IPTV-Windows-1.0.5.msi`
...
**Or without installing** — `Killua-IPTV-Windows-1.0.5.zip`
